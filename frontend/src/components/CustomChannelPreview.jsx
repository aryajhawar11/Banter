...
const CustomChannelPreview = ({ channel, setActiveChannel, activeChannel }) => {
  ...
  const isDM = channel.data.member_count === 2 && channel.data.id.includes("user_"); //if channel id starts with user_ it cmeans its a user and comes in direct messages
