...
const UsersList = ({ activeChannel }) => {
  ...
  const [_, setSearchParams] = useSearchParams(); //here _ is used to ignore the current value of the search params we only need to set it
          ...
          >
            <div className="flex items-center gap-2 w-full">
              <div className="relative">
                ...
                {/* if  image is available then show it otherwise show the first letter of the name */}
